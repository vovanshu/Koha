...
('generate_userid_bycardnumber', '0', '', 'Generate userid by cardnumber', 'YesNo'),
('IndependentLibraryMemberNum', '0', '', 'If ON, patron number is auto-calculated for each library independet', 'YesNo')
;
